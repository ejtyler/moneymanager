...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { amount: @subscription.amount, due_date: @subscription.due_date, title: @subscription.title } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { amount: @subscription.amount, due_date: @subscription.due_date, title: @subscription.title } }
